...
const Testimonials = () => {
  return (
    <>
      <h2 className="text-3xl font-semi-bold text-center  pt-16 ">
        <span className="text-black ">What</span>{" "}
        <span className="text-[#f22613]">Client Says?</span>
      </h2>
      <section
        className="mt-20 bg-top-center bg-no-repeat bg-cover overlay "
        style={{
          backgroundImage:
      ...
      >
        <Swiper
          ...
          className=" sm:my-20 z-0 mySwiper w-screen min-h-[40vh]"
        >
          {/* slider per view */}
